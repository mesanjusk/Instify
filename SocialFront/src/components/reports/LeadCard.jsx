...
const LeadCard = memo(function LeadCard({
  ...
  return (
    <div
      onClick={() => selectionMode ? onCheckboxChange?.() : onSelect(lead)}
      className={`relative border rounded-lg p-4 shadow hover:shadow-md transition cursor-pointer flex flex-col justify-between ${selected ? 'ring-2 ring-blue-500 bg-blue-50' : ''}`}
    >
      {selectionMode && (
